...
<div class="container-fluid">
    <form action="" id="manage-request">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="patient" value="<?php echo isset($patient) ? $patient :'' ?>"
                required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="volume"
                value="<?php echo isset($volume) ? $volume / 1000 :'' ?>" required>
        </div>
        <div class="form-group">
            <label for="" class="control-label">Physician Name</label>
            <input type="text" class="form-control" name="physician_name"
                value="<?php echo isset($physician_name) ? $physician_name :'' ?>" required>
        </div>
        <?php if(isset($status)): ?>
        <div class="form-group">
...
$('[name="blood_group"]').change(function() {
    ...
    // 	method:'POST',
    // 	data:{blood_group:$(this).val(),id:'<?php
    //  echo isset($id)? $id : '' 
    // 	 ?>'},
